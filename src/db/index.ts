...
/**
 * A conexao vem sempre de `DATABASE_URL`: em desenvolvimento pelo `.env.local`,
 * em producao pela variavel de ambiente do host (na Vercel ela aponta para o
 * endpoint com pool do Neon).
 */
